...
if [ "$#" -ne 2 ]; then
    echo "Usage: $0 <input_refflat_file> <output_refflat_file>"
    echo "Example: $0 ../data.refflat data_converted.refflat"
    exit 1
fi
...
# Format: <New_Name> <Original_Accession>
...
echo "Processing RefFlat: $INPUT_FILE -> $OUTPUT_FILE"
